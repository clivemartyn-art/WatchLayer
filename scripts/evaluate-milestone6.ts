...
if(!args.includes('--all')||phase!=='final') throw new Error('Use --phase final --all; this explicitly selects the full cohort.');
...
const directory=resolve('reports/milestone6',phase);await mkdir(directory,{recursive:true});

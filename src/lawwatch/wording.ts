export const REPORT_STATEMENT='This report identifies public website signals only and does not certify regulatory compliance.';
export const wording={
  ...
  notObserved:'The monitored surface was not reliably observed. No removal was inferred.',
  changed:'Material change detected. Review the current pricing information.',
};
